...
final readonly class ToolsProSecondReminderNotificationData implements EmailCapable, NotificationData
{
    use RendersEmail;
    ...
    {
        return NotificationType::ToolsProSecondReminderNotification;
    }
}
